    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-20">
          <h1 className="text-5xl md:text-6xl font-bold">IBRAHIM CLINIC</h1>

          <p className="mt-4 text-2xl">Dr. Aftab A. Khan (B.U.M.S.)</p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-6 mt-10">
          <div className="bg-white shadow-md rounded-2xl p-6">
            <h3 className="font-bold text-lg">Online Booking</h3>
          ...
          <div className="bg-white shadow-md rounded-2xl p-6">
            <h3 className="font-bold text-lg">Follow-Ups</h3>
            <p className="mt-3 text-gray-600">Track follow-up appointments.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="mt-8 text-lg">
            Shop No. 12, Sunshine Garden, Achole Road, Nallasopara East
          </p>
